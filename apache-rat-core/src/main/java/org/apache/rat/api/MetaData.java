...
public class MetaData {
    ...
    public static final String RAT_DOCUMENT_CATEGORY_VALUE_STANDARD =
            "standard";
    public static final Datum RAT_DOCUMENT_CATEGORY_DATUM_GENERATED =
            new Datum(RAT_URL_DOCUMENT_CATEGORY,
    ...
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_W3CD =
            new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,
    ...
    public Datum get(final String name) {
        Datum result = null;
        for (final Datum next : this.data) {
    ...
    public boolean clear(final String name) {
        ...
        for (final Iterator<Datum> it = this.data.iterator(); it.hasNext();) {
